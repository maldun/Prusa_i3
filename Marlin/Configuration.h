...
#define STRING_CONFIG_H_AUTHOR "(Stefan, my config)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.5, 80.5,400*1.014,93.5*1.1} // default steps per unit for Sunhokey Prusa i3
